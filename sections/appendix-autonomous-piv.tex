...
\begin{SimpleTable}{PIV Auto Vector Sources}{3}
  ...
  Generated YubiKey PIV & Missing algorithm profiles & Reusable RSA-1024, RSA-3072, and P-384 test keys are committed as public fixtures and loaded through \code{ykman piv}; RSA-1024 is informative legacy material only. \\\hline
\end{SimpleTable}
