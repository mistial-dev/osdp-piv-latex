...
\begin{description}
  ...
  \item[Biometric Information Templates (BIT) Group Template] Object identifier \code{0x007F61}, tag \code{0x00}, offset \code{0x0000}. Large responses for fingerprint or iris templates require multiple \texttt{osdp\_PIVDATAR} fragments; the \texttt{TOTAL}/\texttt{OFFSET}/\texttt{DATA\_LEN} fields support reconstruction.
