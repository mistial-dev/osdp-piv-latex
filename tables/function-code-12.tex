\begin{center}
  ...
  \begin{tabular}{|c|p{9cm}|}
    ...
    0x04 & PD supports the OSDP~3.0 Enhanced PIV profile, including \texttt{osdp\_PIVDATA} refinements and related commands. \\\hline
    0x08 & PD supports OSDP~3.0 autonomous PIV operation (PIV Auto). \\\hline
  \end{tabular}
\end{center}
